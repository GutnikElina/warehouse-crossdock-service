...
class DistributedLockExecutorIntegrationTest {
    ...
    void shouldThrowExceptionWhenSecondThreadTriesToAcquireSameLock() throws Exception {
        ...
        CompletableFuture<Void> threadA = CompletableFuture.runAsync(() ->
                executor.executeWithLock(lockKey, 100, 2000, TimeUnit.MILLISECONDS, () -> {
                    try {
                        Thread.sleep(500);
        ...
        CompletableFuture<Void> threadB = CompletableFuture.runAsync(() ->
                executor.executeWithLock(lockKey, 100, 2000, TimeUnit.MILLISECONDS, () -> "Thread B done")
        );
    ...
    void shouldAllowSecondThreadToAcquireLockAfterFirstReleasesIt() {
        ...
        String resultA = executor.executeWithLock(lockKey, 100, 1000, TimeUnit.MILLISECONDS, () -> "Result A");
        String resultB = executor.executeWithLock(lockKey, 100, 1000, TimeUnit.MILLISECONDS, () -> "Result B");

...
class GateBookingReservationIntegrationTest {
  ...
  @Container
  static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16").withDatabaseName("crossdock");
  ...
  void returns201_andPersistsSlot_onFirstReservation() {
    ...
    ReserveSlotRequest request = gateTestDataFactory.requestFor(gateId, routeId,
    ...
    ResponseEntity<ReserveSlotResponse> response = restTemplate.postForEntity(
            ...
            request, ReserveSlotResponse.class, hubId);
  ...
  void returns404_whenGateDoesNotBelongToHub() {
    ...
    ReserveSlotRequest request = gateTestDataFactory.requestFor(
            otherHubsGateId, routeId,"2026-09-01T09:00:00Z",
            "2026-09-01T09:45:00Z", TransportType.TRUCK, TemperatureMode.DRY);

    ResponseEntity<ErrorDetails> response = restTemplate.postForEntity(
            "/api/v1/hubs/{hubId}/slots/reserve",
            request, ErrorDetails.class, hubId);
  ...
  void returns422_whenGateCannotHandleFrozenCargo() {
    ...
    ReserveSlotRequest frozenCargoRequest = gateTestDataFactory.requestFor(
            dryGateId, routeId,"2026-09-01T13:00:00Z", "2026-09-01T13:45:00Z",
            TransportType.TRUCK, TemperatureMode.FROZEN);

    ResponseEntity<ErrorDetails> response = restTemplate.postForEntity(
            "/api/v1/hubs/{hubId}/slots/reserve",
            frozenCargoRequest, ErrorDetails.class, hubId);
  ...
  void exactlyOneRequestSucceeds_underConcurrentDoubleBooking() throws Exception {
    ...
    UUID routeId = gateTestDataFactory.seedRoute();
    ReserveSlotRequest request = gateTestDataFactory.requestFor(gateId, routeId,
            "2026-09-01T15:00:00Z", "2026-09-01T15:45:00Z", TransportType.TRUCK, TemperatureMode.DRY);
